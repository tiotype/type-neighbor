...
import fontsData from "../../data/merriweather.json"
...
function Merriweather() {
  ...
  useEffect(() => {
    setFonts(
      fontsData.merriweather.map(item => ({
        ...item,
        overflow: true,
  ...
  return (
    <>
      ...
      <Layout>
        <Container fluid className="merriweather">
          ...
          <Container fluid className="fonts font-name-contain" id="tester">
            <Row>
              <Col md={12}>
                <p className="font-name-header merriweather-regular">
                  Merriweather
                </p>
              </Col>
            </Row>
          ...
          <Container className="font-desc" id="info">
            <Row>
              <Col md={12}>
                <p className="desc-name">Merriweather</p>
                <p className="desc-status">Designer: Sorkin Type</p>
                <p className="desc-status">
                  "Merriweather was designed to be a text face that is pleasant
                  to read on screens. It features a very large x height,
                  slightly condensed letterforms, a mild diagonal stress, sturdy
                  serifs and open forms." &mdash; Google Fonts
                </p>
                <p className="desc-status">
