...
import fontsData from "../../data/ultra.json"
...
function Ultra() {
  ...
  return (
    <>
      ...
      <Layout>
        <Container fluid className="ultra">
          ...
          <Container fluid className="fonts font-name-contain" id="tester">
            <Row>
              <Col md={12}>
                <p className="font-name-header ultra">Ultra</p>
              </Col>
            </Row>
          </Container>
          ...
          <Container className="font-desc" id="info">
            <Row>
              <Col md={12}>
                <p className="desc-name">Ultra</p>
                <p className="desc-status">Designer: Astigmatic</p>
                <p className="desc-status">
                  "Ultra is an ultra bold slab typeface with nods to wood type
                  styles like Clarendon and Egyptian. Strong and dramatic
                  letterforms for titling, a serious, yet friendly, and easily
                  legible typestyle. Perfect for power headlines and titling for
                  impact." &mdash; Google Fonts
                </p>
                <p className="desc-status">
                  <a href="https://fonts.google.com/specimen/Ultra">
                    Ultra on Google Fonts
                  </a>
                </p>
              </Col>
            </Row>
