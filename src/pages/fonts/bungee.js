...
import fontsData from "../../data/bungee.json"
...
function Bungee() {
  ...
  return (
    <>
      ...
      <Layout>
        <Container fluid className="bungee">
          ...
          <Container fluid className="fonts font-name-contain" id="tester">
            <Row>
              <Col md={12}>
                <p className="font-name-header bungee-outline">Bungee</p>
              </Col>
            </Row>
          </Container>
          ...
          <Container className="font-desc" id="info">
            <Row>
              <Col md={12}>
                <p className="desc-name">Bungee</p>
                <p className="desc-status">Designer: David Jonathan Ross</p>
                <p className="desc-status">
                  "In the crowded urban environment, space for signage is always
                  at a premium. From dumpy liquor stores to majestic theaters,
                  sometimes signs have nowhere to go but up. Bungee is a font
                  family that celebrates urban signage. It wrangles the Latin
                  alphabet to work vertically as well as horizontally." &mdash;
                  Google Fonts
                </p>
                <p className="desc-status">
                  <a href="https://fonts.google.com/specimen/Bungee">
                    Bungee on Google Fonts
                  </a>
                </p>
              </Col>
            </Row>
